...
export default function Home() {
  ...
  const { data, error, isLoading } = useSWR(celcius===false ? `https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${long}&&appid=${apiKey}&units=imperial`:`http://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${long}&&appid=${apiKey}&units=metric`, fetcher)
